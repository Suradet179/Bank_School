 ...
 try {
        ...
        await DepositById(sid,prefix,fname,lname,primary,money,generation,RafID,count);
        await Update_d_MoneyById(sid,money);
        await Update_d_Money(money,generation);
        await Update_deposit(money,sid);
        await Deposit_Amount(sid);
        await SumMoneyDeposit(generation,money);
