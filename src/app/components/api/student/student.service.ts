...
//////////ข้อมูลนักเรียน
  ...
  createStudent(studentAdd): Observable<StudentModel> {
    return this.http.post<StudentModel>(this.apiURL + "add_sudent", JSON.stringify(studentAdd), this.httpOptions)
  }

  // แก้ไข
  editStudent(sid, studentEdit): Observable<StudentModel> {
    return this.http.put<StudentModel>(this.apiURL + "update_student/" + sid, JSON.stringify(studentEdit), this.httpOptions)
  }

  //ลบ
  deleteStudent(id) {
    //  return this.http.delete<StudentModel>(this.apiURL + "delete_Student", this.httpOptions)
    return this.http.delete<GetStudentModel>(this.apiURL + "delete_Student/" + id, this.httpOptions)
  }
  ...
  Deposit(depositData): Observable<depositModel> {
    return this.http.post<depositModel>(this.apiURL + "Deposits", JSON.stringify(depositData), this.httpOptions)
  }
  // ถอน
  Withdraw(withdrawData): Observable<withdrawtModel> {
    return this.http.post<withdrawtModel>(this.apiURL + "Withdraws", JSON.stringify(withdrawData), this.httpOptions)
  }
  ...
  createTeacher(teacherAdd): Observable<TeacherModel> {
    return this.http.post<TeacherModel>(this.apiURL + "add_Teacher", JSON.stringify(teacherAdd), this.httpOptions)
  }
  ...
  editTeacher(id, teacherEdit): Observable<TeacherModel> {
    return this.http.put<TeacherModel>(this.apiURL + "update_Teacher/" + id, JSON.stringify(teacherEdit), this.httpOptions)
  }

  //ลบ
  deleteTeacher(id) {
    //  return this.http.delete<StudentModel>(this.apiURL + "delete_Student", this.httpOptions)
    return this.http.delete<idTeacher>(this.apiURL + "delete_Teacher/" + id, this.httpOptions)
  }
  ...
  createSummoney(summoneyAdd): Observable<summoney> {
    return this.http.post<summoney>(this.apiURL + "add_summoney", JSON.stringify(summoneyAdd), this.httpOptions)
  }

  //put sum money
  editSummoney(id, summoneyEdit): Observable<summoney> {
    return this.http.put<summoney>(this.apiURL + "update_summoney/" + id, JSON.stringify(summoneyEdit), this.httpOptions)
  }

  //delete  sum money
  deleteSummoney(id) {
    return this.http.delete<idSummoney>(this.apiURL + "delete_summoney/" + id, this.httpOptions)
  }
...
//แสดงรายการฝาก
  getDepositById(id, generation): Observable<listDepositModel> {
    return this.http.get<listDepositModel>(this.apiURL + 'getDepositById/' + generation + '/' + id)
  }

  getlistMonthlyDeposit(generation,sid,month): Observable<listMonthlyModel> {
    return this.http.get<listMonthlyModel>(this.apiURL + "listDepositMonthly/" + generation + '/' + sid + '/' + month)
  }

  getlistDepositBetweenDate(generation,sid,date1,date2): Observable<listBetweenDateModel> {
    return this.http.get<listBetweenDateModel>(this.apiURL + "listDepositBetweenDate/" + generation + '/' + sid + '/' + date1 + '/' + date2)
  } 

  getDetailDepositById(generation, sid, count): Observable<listDepositModel> {
    return this.http.get<listDepositModel>(this.apiURL + 'getDetailDepositById/' + generation + '/' + sid + '/' + count)
  }
//แสดงรายการถอน
  getWithdrawById(id, generation): Observable<listWithdrawModel> {
    return this.http.get<listWithdrawModel>(this.apiURL + 'getWithdrawById/' + generation + '/' + id)
  }

  getlistMonthlyWithdraw(generation,sid,month): Observable<listMonthlyModel> {
    return this.http.get<listMonthlyModel>(this.apiURL + "listWithdrawMonthly" + generation + '/' + sid + '/' + month)
  }
  
  getlistWithdrawBetweenDate(generation,sid,date1,date2): Observable<listBetweenDateModel> {
    return this.http.get<listBetweenDateModel>(this.apiURL + "listWithdrawBetweenDate"+ generation + '/' + sid + '/' + date1 + '/' + date2)
  }  

  getDetailwithdrawById(generation, sid, count): Observable<listWithdrawModel> {
    return this.http.get<listWithdrawModel>(this.apiURL + 'getDetailwithdrawById/' + generation + '/' + sid + '/' + count)
  }
