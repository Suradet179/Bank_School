import { summoney } from './../../api/student/summoney';
...
ChartSummoneyStudent(){
  ...
  this.api.getSummoneyAll().subscribe(data =>{
    ...
    //กราฟ
  this.barChartData = [
        { data: [this.p1,this.p2,this.p3,this.p4,this.p5,this.p6],  label: 'ยอดเงินคงเหลือ' },  //แท่งที่1
        { data: [this.d1,this.d2,this.d3,this.d4,this.d5,this.d6],  label: 'ยอดเงินฝาก' },  //แท่งที่1
        { data: [this.w1,this.w2,this.w3,this.w4,this.w5,this.w6],  label: 'ยอดเงินถอน' },  //แท่งที่1
  ...
  //กราฟ
    ...
    barChartLabels: Label[] = ['ประถมศึกษาปีที่ 1', 'ประถมศึกษาปีที่ 2', 'ประถมศึกษาปีที่ 3', 'ประถมศึกษาปีที่ 4', 'ประถมศึกษาปีที่ 5', 'ประถมศึกษาปีที่ 6'];   //หัวข้อแนว x ป1 ป2 ป3 ป4
