...
detaildepositById(generation,sid,d_amount_deposit){
  ...
  this.api.getDetailDepositById(generation,sid,d_amount_deposit).subscribe(data =>{
    console.log(data);
...
MonthlyDeposit(generation,sid,month){
   this.api.getlistMonthlyDeposit(generation,sid,month).subscribe((data:{}) => {
...
findBetweenDate(generation,sid,date1,date2){
  this.api.getlistDepositBetweenDate(generation,sid,date1,date2).subscribe((data:{}) => {
