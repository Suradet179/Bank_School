...
detailwithdrawById(generation,sid,W_amount_withdraw){
  ...
  this.api.getDetailwithdrawById(generation,sid,W_amount_withdraw).subscribe(data =>{
    console.log(data);
...
MonthlyWithdraw(generation,sid,month){
   this.api.getlistMonthlyWithdraw(generation,sid,month).subscribe((data:{}) => {
...
findBetweenDate(generation,sid,date1,date2){
  this.api.getlistWithdrawBetweenDate(generation,sid,date1,date2).subscribe((data:{}) => {
